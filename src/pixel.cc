...
//*****************************************************************************
Pixel::Pixel(int image_index, PixelInfo info, ImageTable *image_table)
    : info_(info), image_index_(image_index) {
  CalLabel(image_table);
}
//*****************************************************************************

//*****************************************************************************
Pixel::Pixel(int image_index, PixelInfo info)
    : image_index_(image_index), info_(info) {}
//*****************************************************************************
