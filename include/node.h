...
class Node {
 public:
  ...
  // representative offset of the leaf node. for nodes that are leaf nodes, do
  ...
  // calculate and return the entropy for pixels. say if we want to calculate
  // the entropy for parent, then we feed all the pixels to it
  // if we want to calculate the entropy for left child, we feed the pixels of
  // the left child to it
